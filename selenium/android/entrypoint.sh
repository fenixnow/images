...
emulator ${EMULATOR_ARGS} -verbose -avd @AVD_NAME@ -writable-system -gpu swiftshader_indirect -timezone Europe/Moscow -change-language ru -no-snapshot-save -accel on &
